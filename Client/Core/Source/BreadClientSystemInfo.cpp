...
namespace Bread
{
	HRESULT cClientSystemInfo::getDXVersion(DWORD* pdwDirectXVersion, TCHAR* strDirectXVersion, int cchDirectXVersion)
	{
		return GetDXVersion(pdwDirectXVersion, strDirectXVersion, cchDirectXVersion);
	}
}