...
void cSampleApplication::initPostProcess()
{
	...
	_getPostProcessMgr()->addActive(cPostProcessManager::SSAO);
	_getPostProcessMgr()->addActive(cPostProcessManager::SCALE_ORI);
}
/*
 *	
 */
...
void cSampleApplication::initDebugFlag()
{
	...
	_setIsRenderValue(RENDER_SCENE_OCTREE, 1);
